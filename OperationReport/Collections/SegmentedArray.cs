...
public class SegmentedArray<T> where T : unmanaged
{
    ...
    public SegmentedArray(int segmentCount)
    {
    ...
    private void EnsureCapacity(int capacity)
    {
        ...
        Array.Copy(oldPool, _pool, oldPool.Length);
    }

    private class ArrayView(SegmentedArray<T> parent) : IReadOnlyList<T>
    {
        ...
        public T this[int index]
        {
            get
            {
                ...
                return parent._pool[Offset + index];
            }
        }
        ...
        int offset) : IReadOnlyList<T>
    {
        ...
        private T GetItem(int index) => parent._pool[segments[index] * parent.SegmentSize + offset];
